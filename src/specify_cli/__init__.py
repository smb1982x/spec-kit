...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor, kilocode, qwen or opencode"),
    ...
    2. Let you choose your AI assistant (Claude Code, Gemini CLI, GitHub Copilot, Cursor, Kilo Code, Qwen Code or opencode)
    ...
    if not ignore_agent_tools:
        ...
        if selected_ai == "claude":
            ...
            if not check_tool("opencode", "Install from: https://opencode.ai"):
                ...
                agent_tool_missing = True
        # GitHub Copilot, Cursor, and Kilo Code checks are not needed as they're typically available in supported IDEs
    ...
    if selected_ai == "claude":
        ...
        steps_lines.append(f"{step_num}. Use / commands with Kilo Code")
        steps_lines.append("   - Type /specify to create specifications")
        steps_lines.append("   - Type /plan to create implementation plans")
        steps_lines.append("   - Type /tasks to generate tasks")
        steps_lines.append("   - See .kilocodemodes for all available commands")
    elif selected_ai == "opencode":
...
def check():
    ...
    tracker.add("kilocode", "Kilo Code")
    ...
    kilocode_ok = check_tool_for_tracker("kilocode", "https://kilocode.ai/", tracker)
    ...
    if not (claude_ok or gemini_ok or cursor_ok or kilocode_ok or qwen_ok or opencode_ok):
