...
```bash
uvx --from git+https://github.com/smb1982x/spec-kit.git specify init <PROJECT_NAME>
```
...
| `check`     | Check for installed tools (`git`, `claude`, `gemini`, `code`/`code-insiders`, `opencode`, `cursor-agent`, `kilocode`) |
...
| `--ai`                 | Option   | AI assistant to use: `claude`, `gemini`, `copilot`, `opencode`, `cursor`, or `kilocode`             |
...
specify init my-project --ai kilocode --no-git
...
- AI coding agent: [Claude Code](https://www.anthropic.com/claude-code), [GitHub Copilot](https://code.visualstudio.com/), [Gemini CLI](https://github.com/google-gemini/gemini-cli), [Cursor](https://cursor.sh/), [Qwen CLI](https://github.com/QwenLM/qwen-code), [opencode](https://opencode.ai/), or [Kilo Code](https://kilocode.ai/)
...
The CLI will check if you have Claude Code, Gemini CLI, Qwen CLI, opencode, or Kilo Code installed. If you do not, or you prefer to get the templates without checking for the right tools, use `--ignore-agent-tools` with your command:
